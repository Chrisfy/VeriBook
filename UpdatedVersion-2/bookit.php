...
if($checkcount>=10)
{
?> <script>alert("Ta domatia den einai available !!");</script>
<?php }
else{
...
<div id="contenar">
	...
	<h3> Welcome <?php echo $username ?> <?php session_start(); if(isset($_SESSION['username'])){ echo $_SESSION['username']; } ?> !!!</h3>
...
$finalDate = $_POST['enddate1'];
$contractDateBegin = '2016-1-1';
$contractDateEnd ='2017-1-1';
...
<?php while($catdata=mysql_fetch_array($s3)) { ?>  <option value="<?php echo $catdata['room_price']; ?>"><?php echo $catdata['room_type']; ?></option>
          ...
          <tr>
			...
			<input type="submit" name="sub" value="Book Me!" /></td>
            </tr>
